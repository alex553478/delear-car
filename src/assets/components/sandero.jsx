...
const DaciaSanderoStepway = () => {
  const images = [
    { img: "https://ireland.apollo.olxcdn.com/v1/files/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmbiI6Ink0eTZwamU4ejhuZTMtQVVUT1ZJVFJPIiwidyI6W3siZm4iOiJxN216NTNiaWZwemstQVVUT1ZJVFJPIiwicyI6IjE2IiwiYSI6IjAiLCJwIjoiMTAsLTEwIn1dfQ.Bo42kufrqw74rx7eGThyXcXNZvITrBy3CuXnI9_o0WI/image;s=1440x0;q=80" },
    { img: "https://ireland.apollo.olxcdn.com/v1/files/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmbiI6Ijl5cDdmdjE0amE2bzMtQVVUT1ZJVFJPIiwidyI6W3siZm4iOiJxN216NTNiaWZwemstQVVUT1ZJVFJPIiwicyI6IjE2IiwiYSI6IjAiLCJwIjoiMTAsLTEwIn1dfQ.Q72wKfCg7ZLE17SeWrdDE2zg_86aLyNna7-_EJPq5NM/image;s=1440x0;q=100" },
    { img: "https://ireland.apollo.olxcdn.com/v1/files/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmbiI6ImFicTE1aXR2eGZlaDEtQVVUT1ZJVFJPIiwidyI6W3siZm4iOiJxN216NTNiaWZwemstQVVUT1ZJVFJPIiwicyI6IjE2IiwiYSI6IjAiLCJwIjoiMTAsLTEwIn1dfQ.imRv292DOuuppOHCwdlYkBhAmLhXjwxVgQfjgtqQTv4/image;s=1440x0;q=100" },
    { img: "https://ireland.apollo.olxcdn.com/v1/files/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmbiI6ImQ0cDNodThvZ3RuYi1BVVRPVklUUk8iLCJ3IjpbeyJmbiI6InE3bXo1M2JpZnB6ay1BVVRPVklUUk8iLCJzIjoiMTYiLCJhIjoiMCIsInAiOiIxMCwtMTAifV19.kdei_EcrLVuc2Q30ual7qi6ClI-C-nCj_BUUeyctwjI/image;s=1440x0;q=100" },
  ];
    ...
    <div className="pagina-masina">
      ...
      <div className="servicii-clienti">
        ...
        <div className="informatii-masina">
          ...
          <p>Brand: Dacia</p>
          <p>Model: Sandero Stepway</p>
          <p>Kilometraj: 72.000 km</p>
      ...
      <div className="features-wrapper">
        ...
        <section className="confort-interior">
          ...
          <ul>
            ...
            <li>Regulator viteză + limitator</li>
          </ul>
        </section>
        ...
        <section className="tehnologie-assistance">
          ...
          <ul>
            ...
            <li>Cameră marșarier (opțional)</li>
            <li>Start-Stop</li>
          </ul>
        </section>
        ...
        <section className="estetica">
          ...
          <ul>
            ...
            <li>Protecții plastic</li>
            <li>Faruri LED + DRL</li>
          </ul>
        </section>
      </div>
...
export default DaciaSanderoStepway;
